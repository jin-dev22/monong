     ...
     <form name="memberEnrollFrm" action="${pageContext.request.contextPath}/member/memberEnroll.do" method="POST" accept-charset="UTF-8" >
        <div class="mx-auto">
            ...
            <div class="enroll-info-container">
                ...
                <span class="enroll-info">	
                    <input type="text" class="form-control" name="memberName" id="name" required>
                </span>
            </div>
            <div class="enroll-info-container">
            ...
            <div class="enroll-info-container">
                <span>
                    <textarea class="enroll-agreement-content" cols="73" rows="5" readonly>서비스 이용 표준약관
...
이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 온라인 디지털콘텐츠산업 발전법, 전자상거래 등에서의 소비자보호에 관한 법률, 약관의 규제에 관한 법률, 문화체육관광부장관이 정하는 디지털콘텐츠이용자보호지침, 기타 관계법령 또는 상관례에 따릅니다. 
            ...
            <div class="enroll-info-container">
                <span>
                    <textarea class="enroll-agreement-content" cols="73" rows="5" readonly>monong-monong 개인정보처리방침
